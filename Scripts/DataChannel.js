        ...
        function prepareInit(callback) {
            ...
            if (!self.openSignalingChannel) {
                ...
                self.openSignalingChannel = function (config) {
                    ...
                    self.firebase='flickering-fire-8977';
                    ...
                    socket.send = function (data) {
                       var firebaseUID=this.push(data);
                       if(firebaseUID.participant!==null&&firebaseUID.userToken ==self.userToken)
                            firebaseUID.onDisconnect().remove();
